...
var $author$project$Advent7$demoTree = A2(
	...
	_List_fromArray(
		[
			...
			A2(
			$zwilias$elm_rosetree$Tree$tree,
			A2($author$project$Advent7$Directory, 'etc', _List_Nil),
			_List_Nil),
			A2(
			$zwilias$elm_rosetree$Tree$tree,
...
var $author$project$Advent7$labelToHtml = function (dir) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Advent7$main = function (root) {
	...
	A3($zwilias$elm_rosetree$Tree$restructure, $author$project$Advent7$labelToHtml, $author$project$Advent7$toListItems, $author$project$Advent7$demoTree));
