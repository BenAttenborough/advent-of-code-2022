...
var $Punie$elm_matrix$Matrix$empty = $Punie$elm_matrix$Matrix$Matrix(
...
var $author$project$Advent8$treeRowIterator = F3(
	function (fnc, initialTrees, trees) {
		treeRowIterator:
		while (true) {
			if (!trees.b) {
				return A2(
					...
					$elm$core$List$reverse(initialTrees));
			} else {
				var head = trees.a;
				var tail = trees.b;
				var $temp$fnc = fnc,
					$temp$initialTrees = A2(
					$elm$core$List$cons,
					fnc(trees),
					initialTrees),
					$temp$trees = tail;
				fnc = $temp$fnc;
				initialTrees = $temp$initialTrees;
				trees = $temp$trees;
				continue treeRowIterator;
			}
		}
	});
...
var $author$project$Advent8$treesIterator = function (trees) {
	var rowScenicValuesReverse = $elm$core$Array$fromList(
		$elm$core$List$reverse(
			A3(
				$author$project$Advent8$treeRowIterator,
				$author$project$Advent8$seenTrees,
				_List_Nil,
				$elm$core$List$reverse(trees))));
	var rowScenicValues = $elm$core$Array$fromList(
		A3($author$project$Advent8$treeRowIterator, $author$project$Advent8$seenTrees, _List_Nil, trees));
	return A2(
				...
				return A2(
					...
					A4(
						...
						A2(
							...
							1,
							A2($elm$core$Array$get, index, rowScenicValues)),
						A2(
							$elm$core$Maybe$withDefault,
							1,
							A2($elm$core$Array$get, index, rowScenicValuesReverse))));
			}),
		trees);
};
var $author$project$Advent8$treesIteratorNorthSouth = function (trees) {
	var rowScenicValuesReverse = $elm$core$Array$fromList(
		$elm$core$List$reverse(
			A3(
				$author$project$Advent8$treeRowIterator,
...
var $author$project$Advent8$day8Part2 = function (input) {
	return A2(
		$elm$core$Maybe$map,
		$elm$core$Maybe$map($elm$core$List$maximum),
		A2(
			$elm$core$Maybe$map,
			$elm$core$Maybe$map(
			...
			A2(
				$elm$core$Maybe$map,
				$elm$core$Maybe$map(
					$elm$core$List$map($elm$core$List$maximum)),
				A2(
					$elm$core$Maybe$map,
					$elm$core$Maybe$map($Punie$elm_matrix$Matrix$toLists),
					A2(
						$elm$core$Maybe$map,
						$elm$core$Maybe$map($Punie$elm_matrix$Matrix$transpose),
						A2(
							$elm$core$Maybe$map,
							$Punie$elm_matrix$Matrix$fromLists,
							A2(
								$elm$core$Maybe$map,
								$elm$core$List$map(
									$elm$core$List$map(
										function (treesSeen) {
											return ((treesSeen.north * treesSeen.south) * treesSeen.east) * treesSeen.west;
										})),
								A2(
									$elm$core$Maybe$map,
									$elm$core$List$map(
										$elm$core$List$map(
											function (tree) {
												return tree.treesSeen;
											})),
									A2(
										$elm$core$Maybe$map,
										$elm$core$List$map($author$project$Advent8$treesIteratorNorthSouth),
										A2(
											$elm$core$Maybe$map,
											...
											A2(
												...
												$Punie$elm_matrix$Matrix$fromLists(
													A2(
														$elm$core$List$map,
														$author$project$Advent8$treesIterator,
														A2(
															$elm$core$List$map,
															$elm$core$List$map(
																function (height) {
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$text(
						$elm$core$Debug$toString(
							$author$project$Advent8$day8Part2($author$project$Advent8Data$day8Part1Data)))
					]))
			]));
};
var $author$project$Advent8$main = $author$project$Advent8$view('dummy model');
_Platform_export({'Advent8':{'init':_VirtualDom_init($author$project$Advent8$main)(0)(0)}});}(this));